...
#
# $Id: trowser.pod,v 1.5 2009/03/11 20:24:49 tom Exp $
# ---------------------------------------------------------------------------
...
the home directory, see section FILES.
...
Written by Th. Zoerner L<mailto:tomzo@users.sourceforge.net>

=head1 COPYRIGHT

Copyright 2007-2009,2019-2020 Th. Zoerner. All rights reserved.
