...
# ---------------------------------------------------------------------------
#
# Copyright (C) 2007-2009 Tom Zoerner. All rights reserved.
#
...
#
# $Id: trowser.pod,v 1.3 2009/03/03 15:08:36 tom Exp $
# ---------------------------------------------------------------------------
...
I<Options> menu. The search patterns used to locate timestamps currently
...
C<.trowserc.XXXXX.tmp> in the home directory, where "XXXXX" is a random
...
expressions for highlighting is not recommended.
...
Written by Tom Zoerner L<mailto:tomzo@users.sourceforge.net>
